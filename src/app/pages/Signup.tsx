...
import { Stethoscope, User, ArrowRight, AlertCircle, CheckCircle } from 'lucide-react';
import { Button } from '../components/ui/button';
import { Input } from '../components/ui/input';
import { Label } from '../components/ui/label';
import clinivueLogo from '../../assets/logo.png';
import { registerUser, setCurrentUser } from '../services/mockAuth';
...
export function Signup() {
  ...
  const handleSignup = () => {
    ...
    // Register user
    const authResult = registerUser(email, password, name, selectedRole);
          ...
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-12">
              ...
              >
                ...
                <p className="text-gray-600 mb-8">Join Clinivue today</p>
                ...
                <Button
                  ...
                  disabled={!selectedRole || !name || !email || !password || !confirmPassword || success}
